...
import com.example.schieferprofi.ui.components.WaagerechteCard
...
@Composable
fun DetailWaagerechteScreen(deckungId: String, navController: NavController) {
    ...
    val waagerechte by deckartenViewModel.waagerechte.collectAsState()
    ...
    Column {
        ...
        when {
            ...
            else -> WaagerechteCard(waagerecht = waagerechte, deckung = deckung)
        }
    }
}