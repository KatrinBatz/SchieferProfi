...
import com.example.schieferprofi.ui.components.UnterlegteCard
...
@Composable
fun DetailUnterlegteScreen(deckungId: String, navController: NavController) {
    ...
    val unterlegte by deckartenViewModel.unterlegte.collectAsState()
    ...
    Column {
        ...
        when {
            ...
            else -> UnterlegteCard(unterlegte = unterlegte, deckung = deckung)
        }
    }
}