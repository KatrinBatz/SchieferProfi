...
import com.example.schieferprofi.ui.components.WabenCard
...
@Composable
fun DetailWabenScreen(deckungId: String, navController: NavController) {
    ...
    val waben by deckartenViewModel.waben.collectAsState()
    ...
    Column {
        ...
        when {
            ...
            else -> WabenCard(waben = waben, deckung = deckung)
        }
    }
}