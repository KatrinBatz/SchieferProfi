...
fun DetailDynamischeRechteckScreen(deckungId: String, navController: NavController) {
    ...
    val dynamischeRechteck by deckartenViewModel.dynamischeRechteck.collectAsState()
    ...
    Column {
        ...
        when {
            ...
            else -> DynamischeRechteckDoppeldeckungCard(dynamischeRechteck = dynamischeRechteck, deckung = deckung)
        }
    }
}