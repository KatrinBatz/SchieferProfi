...
import com.example.schieferprofi.ui.components.LineareCard
...
@Composable
fun DetailLineareScreen(deckungId: String, navController: NavController) {
    ...
    val lineare by deckartenViewModel.lineare.collectAsState()
    ...
    Column {
        ...
        when {
            ...
            else -> LineareCard(lineare = lineare, deckung = deckung)
        }
    }
}