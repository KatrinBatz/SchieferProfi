...
import com.example.schieferprofi.ui.components.WildeCard
...
@Composable
fun DetailWildeScreen(deckungId: String, navController: NavController) {
    ...
    val wilde by deckartenViewModel.wildeRechteck.collectAsState()
    ...
    Column {
        ...
        when {
            ...
            else -> WildeCard(wilde = wilde, deckung = deckung)
        }
    }
}