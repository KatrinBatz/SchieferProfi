...
import com.example.schieferprofi.ui.components.SpezialFischschuppeCard
...
@Composable
fun DetailSpezialFischschuppenScreen(deckungId: String, navController: NavController) {
    ...
    val fischschuppe by deckartenViewModel.fischschuppe.collectAsState()
    ...
    Column {
        ...
        when {
            ...
            else -> SpezialFischschuppeCard(fischschuppen = fischschuppe, deckung = deckung)
        }
    }
}