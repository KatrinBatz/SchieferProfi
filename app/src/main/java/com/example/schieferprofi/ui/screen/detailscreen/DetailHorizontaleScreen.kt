...
import com.example.schieferprofi.ui.components.HorizontaleCard
...
@Composable
fun DetailHorizontaleScreen(deckungId: String, navController: NavController) {
    ...
    val horizontale by deckartenViewModel.horizontale.collectAsState()
    ...
    Column {
        ...
        when {
            ...
            else -> HorizontaleCard(horizontale = horizontale, deckung = deckung)
        }
    }
}